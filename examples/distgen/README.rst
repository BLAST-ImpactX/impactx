...
.. _examples-distgen-cutgaussian:

A 6d Truncated Gaussian distribution from Twiss functions
===========================================================

A Gaussian distribution in all 6 phase space variables, with truncation, initialized using Courant-Snyder (Twiss) functions.
...
* **Python** script: ``python3 run_cutgaussian_twiss.py`` or
* ImpactX **executable** using an input file: ``impactx input_cutgaussian_twiss.in``
...
.. tab-set::
   ...
   .. tab-item:: Python: Script
       ...
       .. literalinclude:: run_cutgaussian_twiss.py
          :language: python3
          :caption: You can copy this file from ``examples/distgen/run_cutgaussian_twiss.py``.

   .. tab-item:: Executable: Input File

       .. literalinclude:: input_cutgaussian_twiss.in
          :language: ini
          :caption: You can copy this file from ``examples/distgen/input_cutgaussian_twiss.in``.
