...
.. figure:: gbend_geometry.svg
   ...
   Geometry of a basic sector bend (upper) and a general bend with non-normal entry and exit angles (lower).  These figures are excerpts from the MaryLie Manual, Figs. 6.2.1 and 6.4.1, 
   respectively.
