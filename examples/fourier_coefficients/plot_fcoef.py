...
parser = argparse.ArgumentParser(description="Plot the reconstruction of on-axis data from Fourier coefficients.")
parser.add_argument(
...
ax1.legend(handles=input_data + output_data + diff_data, loc="upper center", prop={"size": 11})
