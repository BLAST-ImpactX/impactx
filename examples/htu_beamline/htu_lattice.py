...
def get_lattice( code,
    ...
    Aline1 = screen("UC_ALineEbeam1", code, experiment_configuration_file, experiment_analysis_settings)
    Aline2 = screen("UC_ALineEBeam2", code, experiment_configuration_file, experiment_analysis_settings)
    Aline3 = screen("UC_ALineEBeam3", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam1 = screen("UC_VisaEBeam1", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam2 = screen("UC_VisaEBeam2", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam3 = screen("UC_VisaEBeam3", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam4 = screen("UC_VisaEBeam4", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam5 = screen("UC_VisaEBeam5", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam6 = screen("UC_VisaEBeam6", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam7 = screen("UC_VisaEBeam7", code, experiment_configuration_file, experiment_analysis_settings)
    VisaEBeam8 = screen("UC_VisaEBeam8", code, experiment_configuration_file, experiment_analysis_settings)
    ...
    angle_rad = 0.001438389904456 * chicane_r56**.5
...
def screen( name, code, experiment_configuration_file=None, experiment_analysis_settings=True ):
    """
    Define a screen element.
    """
...
def kicker( name, current_h, current_v, max_current, max_integrated_field, code, reference_energy_eV=100e6 ):
    ...
    Define a kicker element.
    """
    angle_h = current_to_angle(current_h, max_current, max_integrated_field, reference_energy_eV)
    angle_v = current_to_angle(current_v, max_current, max_integrated_field, reference_energy_eV)
    if code.startswith("cheetah") and cheetah_available:
        ...
        return elements.Kicker(name=name, xkick=angle_h, ykick=angle_v, unit="dimensionless")
    else:
        raise ValueError(f"Unsupported code: {code}")
