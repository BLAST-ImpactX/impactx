...
c7 = 1/(2*cs**3*(1+delta))*(g*Kar[1]/(2*rc**2)+(1+sn**2)*g/rc**2*Kar[2])
...
Omega_initial = xi*c1 - xi*c2 + pxi*c3 + (xi*pxi-yi*pyi)*c4 + (xi**2-yi**2)*c5 - xi**2*c6 + yi**2*c7 - xi**3*c8 + xi*yi**2*c9 \
+ (xi**2*pxi - yi**2*pxi - 2*xi*yi*pyi)*c10 - yi**2*pxi*c11 + yi**4*c12 + xi*c13 + (yi**2-xi**2)*c14 + (xi*yi**2/2 - xi**3/6)*c15
...
Omega_final = xf*c1 - xf*c2 + pxf*c3 + (xf*pxf-yf*pyf)*c4 + (xf**2-yf**2)*c5 - xf**2*c6 + yf**2*c7 - xf**3*c8 + xf*yf**2*c9 \
+ (xf**2*pxf - yf**2*pxf - 2*xf*yf*pyf)*c10 - yf**2*pxf*c11 + yf**4*c12 + xf*c13 + (yf**2-xf**2)*c14 + (xf*yf**2/2 - xf**3/6)*c15
